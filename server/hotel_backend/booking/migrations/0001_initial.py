    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(choices=[('physical', 'Physical Payment'), ('gcash', 'GCash'), ('on_site', 'On-Site')], default='gcash', max_length=20)),
                ...
                ('paymongo_source_id', models.CharField(blank=True, help_text='PayMongo source ID', max_length=255, null=True)),
                ('paymongo_payment_id', models.CharField(blank=True, help_text='PayMongo payment ID', max_length=255, null=True)),
