...
urlpatterns = [
    ...
    path('auth/check_old_password', views.check_old_password, name='check_old_password'),
    path('auth/change_new_password', views.change_new_password, name='change_new_password'),
